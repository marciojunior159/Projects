...
class DDPG:
    ...
    def __init__(self, task):
        ...
        self.exploration_updater = 0.997
        self.noise = OUNoise(self.action_size, self.exploration_mu, self.exploration_theta, self.exploration_sigma, self.exploration_updater)
