...
\hspace{4ex}Pretende-se controlar o nível de água de ambos os tanques da planta, para isso, foi implementado os controladores Proporcional (P), Proporcional Integrativo (PI), Proporcional Derivativo (PD), Proporcional Integrativo Derivativo (PID) e … (PI-D). Quem irá escolher qual controle será usado é o usuário, através da interface do programa desenvolvido, como mostrado na figura  ...:
...
\begin{figure}[H]
     \centering
     \subfloat[][Controlador Mestre]{\includegraphics[width=4cm]{controlador1}\label{<figureP1>}}\hspace{4ex}
     \subfloat[][Controlador Escravo]{\includegraphics[width=4cm]{controlador2}\label{<figureP2>}}\\
